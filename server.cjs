...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Military Transition Readiness Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Service Member";
process.env.TABLE_NAME = process.env.TABLE_NAME || "service_member_records";
'use strict';
